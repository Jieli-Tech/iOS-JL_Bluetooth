...
-(void)handleContentUI{
    ...
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("混响") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    NSMutableAttributedString *depthLabelString = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("深度") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    NSMutableAttributedString *intensityLabelString = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("强度") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    NSMutableAttributedString *string_2 = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("动态限幅器") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    //混响的开关
    switch_1.frame = CGRectMake([DFUITools screen_2_W]-12-41-20.5, kJL_HeightNavBar+13, 41, 21);
    ...
    if(model.reverberationTypes.count ==0){ //混响、振幅器都不支持
        ...
        [DFUITools showText:kJL_TXT("当前固件不支持混响和限幅器") onView:self.view delay:2.0];
...
-(void)handleDepthValue:(IACircularSlider*)slider{
    ...
    if(model.reverberationTypes.count ==0){ //混响、振幅器都不支持
        if(bleSDK.mBleEntityM){
            ...
            switch_1.on = 0;
            [DFUITools showText:kJL_TXT("当前固件不支持混响") onView:self.view delay:1.0];
        }
    }else{
        if(switch_1.on){
...
-(void)handleDynamicLimiterValue:(IACircularSlider*)slider{
    ...
    if(model.reverberationTypes.count ==0){ //混响、振幅器都不支持
        if(bleSDK.mBleEntityM){
            slider.userInteractionEnabled = NO;
            [DFUITools showText:kJL_TXT("当前固件不支持动态限幅器") onView:self.view delay:1.0];
        }
    }
...
-(void)sendMessage{
    ...
    [bleSDK.mBleEntityM.mCmdManager cmdSetReverberation:[depthLabel.text intValue]
