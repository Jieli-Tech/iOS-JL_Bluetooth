...
-(void)setupUI{
    ...
    for(int i = 0;i<mDataArray.count;i++){
        ...
        if(model.mId == 0){  //变声
            ...
            if(model.column){
                ...
                CGRect bianShenRect = CGRectMake(20,mBianshenImv.frame.size.height+mBianshenImv.frame.origin.y+18, [DFUITools screen_2_W]-2*20, 38*bianShengKMaxRowCount+15);
                if(bianShenView == nil){
            ...
            [bianShenView onBianShenViewBlock:^(NSInteger tag) {
                [self->bleSDK.mBleEntityM.mCmdManager cmdSetKalaokIndex:tag Value:0];
            }];
        ...
        if(model.mId == 1){ //气氛
            ...
            if(model.column){
                ...
                CGRect mQiFenRect = CGRectMake(20,qifenImv.frame.size.height+qifenImv.frame.origin.y+20.5, [DFUITools screen_2_W]-2*20, 107.5*qiFenKMaxRowCount);
                if(kalaokView!=nil){
        ...
        if(model.mId == 2){ //Mic参数
            ...
            if(canShuArray.count>0 && canShuIndexArray.count>0&&canShuEnableArray.count>0 && canShuMaxArray.count>0){
                ...
                if(mySlier_1 == nil){
                    mySlier_1=[[UISlider alloc]initWithFrame:CGRectMake(label_1.frame.origin.x+label_1.frame.size.width/2,canshuImv.frame.size.height+canshuImv.frame.origin.y+17.5,sW-mySlier_1.frame.origin.x-112,15)];
                }
                ...
                [mySlier_1 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_2 == nil){
                    mySlier_2=[[UISlider alloc]initWithFrame:CGRectMake(label_2.frame.origin.x+label_2.frame.size.width/2,label_1.frame.size.height+label_1.frame.origin.y+26.5,sW-mySlier_2.frame.origin.x-112,15)];
                }
                ...
                [mySlier_2 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_3 == nil){
                    mySlier_3=[[UISlider alloc]initWithFrame:CGRectMake(label_3.frame.origin.x+label_3.frame.size.width/2,label_2.frame.size.height+label_2.frame.origin.y+26.5,sW-mySlier_3.frame.origin.x-112,15)];
                }
                ...
                [mySlier_3 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_4 == nil){
                    mySlier_4=[[UISlider alloc]initWithFrame:CGRectMake(label_4.frame.origin.x+label_4.frame.size.width/2,label_3.frame.size.height+label_3.frame.origin.y+26.5,sW-mySlier_4.frame.origin.x-112,15)];
                }
                ...
                [mySlier_4 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_5 == nil){
                    mySlier_5=[[UISlider alloc]initWithFrame:CGRectMake(label_5.frame.origin.x+label_5.frame.size.width/2,label_4.frame.size.height+label_4.frame.origin.y+26.5,sW-mySlier_5.frame.origin.x-112,15)];
                }
                ...
                [mySlier_5 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_6 == nil){
                    mySlier_6=[[UISlider alloc]initWithFrame:CGRectMake(label_6.frame.origin.x+label_6.frame.size.width/2,label_5.frame.size.height+label_5.frame.origin.y+26.5,sW-mySlier_6.frame.origin.x-112,15)];
                }
                ...
                [mySlier_6 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
                ...
                if(mySlier_7 == nil){
                    mySlier_7=[[UISlider alloc]initWithFrame:CGRectMake(label_7.frame.origin.x+label_7.frame.size.width/2,label_6.frame.size.height+label_6.frame.origin.y+26.5,sW-mySlier_7.frame.origin.x-112,15)];
                }
                ...
                [mySlier_7 setThumbImage:[UIImage imageNamed:@"Theme.bundle/slider_nol"] forState:UIControlStateNormal];
        ...
        if(model.mId == 3){  //其他
            ...
            if(model.column){
                ...
                CGRect mOtherViewRect = CGRectMake(20,otherImv.frame.size.height+otherImv.frame.origin.y+18, [DFUITools screen_2_W]-2*20, 38*otherKMaxRowCount+15);
    ...
    scrollView.contentSize = CGSizeMake([DFUITools screen_2_W], 20+bianshenImv.frame.size.height+18+bianShenView.frame.size.height+28+otherImv.frame.size.height
...
- (void)btn_Canshu:(UISlider *)sender {
    ...
    [bleSDK.mBleEntityM.mCmdManager cmdSetKalaokIndex:index Value:value];
}
