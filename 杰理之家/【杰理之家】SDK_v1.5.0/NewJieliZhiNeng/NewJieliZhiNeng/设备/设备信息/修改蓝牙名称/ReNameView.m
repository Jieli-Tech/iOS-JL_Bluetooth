...
-(void)initUI{
    ...
    [_finishBtn setTitleColor:kColor_0000 forState:UIControlStateNormal];
    ...
    if(type == 0){
        ...
        if(type == 1){
            if (@available(iOS 13.0, *)) {
                ...
                NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("左耳通透增益值") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: titleColor}];
                
                _titleLab.attributedText = string;
            } else {
                // Fallback on earlier versions
                NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("左耳通透增益值") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: [UIColor colorWithRed:67/255.0 green:67/255.0 blue:67/255.0 alpha:1.0]}];
        ...
        if(type == 2){
            if (@available(iOS 13.0, *)) {
                ...
                NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("右耳通透增益值") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: titleColor}];
                
                _titleLab.attributedText = string;
            } else {
                // Fallback on earlier versions
                NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("右耳通透增益值") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 15],NSForegroundColorAttributeName: [UIColor colorWithRed:67/255.0 green:67/255.0 blue:67/255.0 alpha:1.0]}];
...
- (void)finishBtnAction:(UIButton *)sender {
    ...
    if(mType == 1 || mType ==2){
        ...
        if([_nameTxfd.text intValue]>value || [_nameTxfd.text intValue]<0){
            [DFUITools showText:kJL_TXT("超出通透增益值的范围") onView:self delay:1.0];
            return;
        }
