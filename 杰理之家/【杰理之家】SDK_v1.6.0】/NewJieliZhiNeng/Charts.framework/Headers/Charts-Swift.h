...
@property (nonatomic, strong) UIColor * _Nonnull axisBackgroundColor;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull axisHaveBgC;
...
enum BarGradientOrientation : NSInteger;
...
@property (nonatomic, copy) NSArray<NSArray<UIColor *> *> * _Nullable barGradientColors;
@property (nonatomic) enum BarGradientOrientation barGradientOrientation;
///
/// returns:
/// The gradient colors at the given index of the DataSet’s gradient color array.
/// This prevents out-of-bounds by performing a modulus on the gradient color index, so colours will repeat themselves.
- (NSArray<UIColor *> * _Nullable)barGradientColorAt:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// Rounded Corners
@property (nonatomic) CGFloat barCornerRadius;
/// Masked Corners to draw
@property (nonatomic) BOOL barMaskedCorners;
...
typedef SWIFT_ENUM(NSInteger, BarGradientOrientation, closed) {
  BarGradientOrientationVertical = 0,
  BarGradientOrientationHorizontal = 1,
};
...
+ (NSArray<NSArray<UIColor *> *> * _Nonnull)gradients SWIFT_WARN_UNUSED_RESULT;
...
- (void)drawLabelWithContext:(CGContextRef _Nonnull)context formattedLabel:(NSString * _Nonnull)formattedLabel x:(CGFloat)x y:(CGFloat)y attributes:(NSDictionary<NSAttributedStringKey, id> * _Nonnull)attributes constrainedToSize:(CGSize)constrainedToSize anchor:(CGPoint)anchor angleRadians:(CGFloat)angleRadians bgColor:(UIColor * _Nonnull)bgColor;
- (void)renderGridLinesWithContext:(CGContextRef _Nonnull)context;
