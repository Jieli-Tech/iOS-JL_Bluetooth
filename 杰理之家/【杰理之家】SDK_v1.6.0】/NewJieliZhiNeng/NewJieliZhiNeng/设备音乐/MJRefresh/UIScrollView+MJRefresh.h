 ...
 *  设置头部控件的文字
 */
@property (copy, nonatomic) NSString *headerPullToRefreshText; // 默认:@"pulldown_refresh"
@property (copy, nonatomic) NSString *headerReleaseToRefreshText; // 默认:@"loosen_to_refresh"
