...
-(void)loadDanyinList:(NSArray *)danYinArray{
    ...
    [closeBtn setTitle:kJL_TXT("noise_mode_close") forState:UIControlStateNormal];
    ...
    UIButton *topBtn = [[UIButton alloc] initWithFrame:CGRectMake(0,0,[UIScreen mainScreen].bounds.size.width,self->sH-580.0)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [bleSDK.mBleEntityM.mCmdManager.mSoundCardManager cmdSetKalaokIndex:(long)[indexArray[indexPath.row] integerValue] Value:0];
