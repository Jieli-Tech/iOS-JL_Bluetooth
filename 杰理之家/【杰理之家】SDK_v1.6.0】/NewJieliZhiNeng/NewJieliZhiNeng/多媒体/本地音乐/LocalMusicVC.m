...
-(void)initUI{
    ...
    //名称
    titleName.text = kJL_TXT("multi_media_local");
    mindListView = [[MindListView alloc] initWithFrame:CGRectMake(0, headHeight.constant+10, [UIScreen mainScreen].bounds.size.width,  [UIScreen mainScreen].bounds.size.height-headHeight.constant-10)];
