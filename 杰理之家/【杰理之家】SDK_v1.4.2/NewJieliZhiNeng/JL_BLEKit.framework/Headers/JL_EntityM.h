...
@property(nonatomic,strong) NSString        *mPAIR_W;             //配对【写】通道AE03
@property(nonatomic,strong) NSString        *mPAIR_R;             //配对【读】通道AE04
@property(nonatomic,strong) NSString        *mAUIDO_W;            //音频【写】通道AE05
@property(nonatomic,strong) NSString        *mAUIDO_R;            //音频【读】通道AE06
