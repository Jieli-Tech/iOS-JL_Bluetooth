...
#pragma mark ---> 设备更新表盘(文件) 【kJL_MANAGER_WATCH_FACE】
// 返回 字符串
...
/**
 ...
 @param flag        开始:0x01  结束:0x00
 */
-(void)cmdWriteProtectFlashFlag:(uint8_t)flag Result:(JL_FlashProtect_BK)result;
...
@property(assign,nonatomic)uint8_t          mFlashType;     //系统类型 0:FAT
...
@property(assign,nonatomic)uint16_t         mFlashMtu;      //发包窗口大小
