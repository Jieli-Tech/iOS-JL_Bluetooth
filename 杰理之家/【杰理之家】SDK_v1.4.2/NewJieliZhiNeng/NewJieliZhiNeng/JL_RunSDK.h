...
//iPhoneX系列
#define kJL_HeightStatusBar ((kJL_IS_IPHONE_X==YES || kJL_IS_IPHONE_Xr ==YES || kJL_IS_IPHONE_Xs== YES || kJL_IS_IPHONE_Xs_Max== YES) ? 44.0 : 20.0)
#define kJL_HeightNavBar ((kJL_IS_IPHONE_X==YES || kJL_IS_IPHONE_Xr ==YES || kJL_IS_IPHONE_Xs== YES || kJL_IS_IPHONE_Xs_Max== YES) ? 88.0 : 64.0)
#define kJL_HeightTabBar ((kJL_IS_IPHONE_X==YES || kJL_IS_IPHONE_Xr ==YES || kJL_IS_IPHONE_Xs== YES || kJL_IS_IPHONE_Xs_Max== YES) ? 83.0 : 49.0)
