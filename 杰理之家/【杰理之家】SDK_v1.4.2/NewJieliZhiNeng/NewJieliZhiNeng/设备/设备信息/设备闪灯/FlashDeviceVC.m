    ...
    if (isEffect == NO) {
        ...
        if (bleType != 1) { //音箱
            if(indexPath.row==3 || indexPath.row==5){
                ...
                view.frame = CGRectMake(0,0,[DFUITools screen_2_W],10);
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (isEffect == NO) {
        ...
        [bleSDK.mBleEntityM.mCmdManager cmdHeatsetLedSettingScene:(uint8_t)sceneIndex
