...
@interface DeviceInfoVC ()<HeadSetControlDelegate,NormalSettingDelegate,ReNameViewDelegate,MofifyNameAlertDelegate>{
...
-(void)initWithUI{
    ...
    if (self.headsetDict) {
        ...
        if (headSetView) {
            headSetView.frame = CGRectMake(0, 0, width, eHeight);
        }else{
            headSetView = [[HeadSetControlView alloc] initWithFrame:CGRectMake(0, 0, width, eHeight)];
