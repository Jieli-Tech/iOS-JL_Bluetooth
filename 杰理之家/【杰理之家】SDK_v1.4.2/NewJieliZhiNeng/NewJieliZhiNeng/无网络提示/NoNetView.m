...
-(void)initUI{
    ...
    bgView.frame = CGRectMake(0,0,[DFUITools screen_2_W],40);
    ...
    noNetLabel.frame = CGRectMake(53.5,13,[DFUITools screen_2_W]-19.0,13.5);
    noNetLabel.numberOfLines = 0;
    [self addSubview:noNetLabel];

    NSMutableAttributedString *noNetStr = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("无网络连接，请检查你的网络设置") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 13],NSForegroundColorAttributeName: [UIColor colorWithRed:36/255.0 green:36/255.0 blue:36/255.0 alpha:1.0]}];
