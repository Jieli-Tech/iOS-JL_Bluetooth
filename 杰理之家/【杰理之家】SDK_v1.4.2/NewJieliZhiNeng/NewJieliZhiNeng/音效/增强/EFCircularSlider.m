...
-(void)initUI{
    ...
    [_bassLabel setFont:[UIFont systemFontOfSize:16.f]];
    ...
    bassLabelStr.frame = CGRectMake(bassCircleImv.frame.size.width/2-10, min_w+30.0+kCircle_h,39,13.5);
    bassLabelStr.numberOfLines = 0;
    [self addSubview:bassLabelStr];
    
    NSMutableAttributedString *bassLabelString = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("低音") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    [_volLabel setFont:[UIFont systemFontOfSize:16.f]];
    ...
    volLabelStr.frame = CGRectMake(volCircleImv.frame.origin.x+volCircleImv.frame.size.width/2-21, min_w+30.0+kCircle_h,50,13.5);
    volLabelStr.numberOfLines = 0;
    [self addSubview:volLabelStr];
    
    NSMutableAttributedString *volLabelString = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("主音量") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
    ...
    [_trebleLabel setFont:[UIFont systemFontOfSize:16.f]];
    ...
    trebleLabelStr.frame = CGRectMake(trebleCircleImv.frame.origin.x+trebleCircleImv.frame.size.width/2-12, min_w+30.0+kCircle_h,39,18);
    trebleLabelStr.numberOfLines = 0;
    [self addSubview:trebleLabelStr];
    
    NSMutableAttributedString *trebleLabelString = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("高音") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1.0]}];
...
-(void)endTouch{
    [JL_Tools mainTask:^{
        ...
        if(self->clickFlag ==0 ||self->clickFlag ==2){ //高低音
            [self->bleSDK.mBleEntityM.mCmdManager cmdSetLowPitch:[self->_bassLabel.text intValue]
                                                       HighPitch:[self->_trebleLabel.text intValue]];
        }
        if (self->bleSDK.mBleEntityM.mType != 1 && self->clickFlag == 1) { //音箱主音量
...
- (void)volumeChanged:(NSNotification *)notification
{
    ...
    if (bleSDK.mBleEntityM.mType == 1) { //耳机
        float val = [notification.userInfo[@"AVSystemController_AudioVolumeNotificationParameter"] floatValue];
...
-(void)updateFirstVol{
    [JL_Tools mainTask:^{
        ...
        if (self->bleSDK.mBleEntityM.mType == 1) { //耳机
...
-(void)addNote{
    ...
    [JL_Tools add:@"AVSystemController_SystemVolumeDidChangeNotification" Action:@selector(volumeChanged:) Own:self];
