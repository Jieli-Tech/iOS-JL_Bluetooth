...
//    arr_vc = @[vc_3];
    ...
    NSArray *arr_txt = @[kJL_TXT("多媒体"),kJL_TXT("音效"),kJL_TXT("设备")];
...
-(void)noteShowOtaAlert:(NSNotification*)note{
    ...
    UIAlertController *actionSheet = [UIAlertController alertControllerWithTitle:@"提示" message:nil
                                                                  preferredStyle:UIAlertControllerStyleAlert];
 
    UIAlertAction *btnCancel = [UIAlertAction actionWithTitle:@"断开设备" style:UIAlertActionStyleCancel
    ...
    UIAlertAction *btnConfirm = [UIAlertAction actionWithTitle:@"立即升级" style:UIAlertActionStyleDefault
                                                   handler:^(UIAlertAction * _Nonnull action) {
