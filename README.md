...
| 版本 | 发布日期 | 编辑者 | 主要更新 |
|------|----------|--------|----------|
| **v1.14.0** | 2026/01/27 | EzioChan | 1. 新增功能<br/>（1）增加 LE Audio 与 RCSP 并存功能<br/>（2）增加 AI 翻译功能<br/>（3）增加 Auracast Broadcast 功能<br/>（4）增加 Gatt Over BR/EDR 连接方式的支持<br/>2.修复功能<br/>（1）修改彩屏仓本地资源 |
