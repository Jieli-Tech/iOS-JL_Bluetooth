...
import Foundation
    ...
    public extension Image {
         ...
         */
        init(_ resource: ImageResource, label: Text) {
        ...
        /**
         ...
         - parameter resource: The resource you want the image of (`R.image.*`)
         */
        init(decorative resource: ImageResource) {
    ...
    // Xcode 14.1 is first to ship with swift 5.7.1
        ...
        public extension Image {
             ...
             */
            init(_ resource: ImageResource, variableValue: Double?) {
            ...
            /**
             ...
             - parameter label: The label associated with the image, for accessibility
             */
            init(_ resource: ImageResource, variableValue: Double?, label: Text) {
            ...
            /**
             ...
             - parameter variableValue: Optional value between 1 and 0
             */
            init(decorative resource: ImageResource, variableValue: Double?) {
    ...
    public extension ImageResource {
        ...
        func callAsFunction(compatibleWith traitCollection: UITraitCollection? = nil) -> UIImage? {
    ...
    public extension UIImage {
        /**
         ...
         - returns: An image that exactly or best matches the desired traits with the given resource (`R.image.*`), or nil if no suitable image was found.
         */
        convenience init?(resource: ImageResource, compatibleWith traitCollection: UITraitCollection? = nil) {
        ...
        convenience init?(resource: ImageResource, with configuration: UIImage.Configuration?) {
...
// Xcode 14.1 is first to ship with swift 5.7.1
    ...
    public extension UIImage {
        ...
        convenience init?(resource: ImageResource, variableValue: Double, with configuration: UIImage.Configuration? = nil) {
