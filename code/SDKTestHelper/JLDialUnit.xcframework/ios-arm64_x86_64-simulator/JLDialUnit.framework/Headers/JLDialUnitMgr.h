...
/// 设备文件列表
@property (nonatomic,readonly,strong)NSMutableArray <JLDialSourceModel *> *fileArray;

/// 当前 Flash 操控句柄
@property (nonatomic,readonly) JLFlashOpMgr *currentFlaghOpMgr;

/// 当前使用的表盘文件
@property (nonatomic,readonly,strong)JLDialSourceModel *currentFileSource;
...
///   - filePath: 文件路径
///   - resultCompletion: 回调
-(void)deleteFile:(NSString *)filePath Completion:(void (^)(BOOL state, NSError * _Nullable error))resultCompletion;
