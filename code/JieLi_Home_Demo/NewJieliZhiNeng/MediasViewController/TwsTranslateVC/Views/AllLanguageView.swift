...
class AllLanguageView: BasicView {
    ...
    private var allLanguages = TranslateLanguage.allLanguages()
    private var sectionTitles = [String]()
    private var sectionedLanguages: [[TranslateLanguage]] = []
    var currentLanguage = BehaviorRelay<TranslateLanguage>(value: .zh)
    ...
    private func sortAndGroupLanguages() {
        ...
        var grouped: [String: [TranslateLanguage]] = [:]
