...
-(void)initUi{
    ...
    if (self.type!=-1) {
        ...
        MJRefreshAutoNormalFooter *footer = (MJRefreshAutoNormalFooter *)self.FileTableView.mj_footer;
        [footer setTitle:kJL_TXT("loosen_load_more") forState:MJRefreshStatePulling];
        [footer setTitle:kJL_TXT("loading_more_data") forState:MJRefreshStateRefreshing];
    }
...
-(void)dmHandleWithItemModelArray:(NSArray<JLModel_File *> *)modelB{
    ...
    [self.FileTableView reloadData];
    if (self.FileTableView.mj_footer.isRefreshing) {
