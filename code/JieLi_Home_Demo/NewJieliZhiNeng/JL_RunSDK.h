...
extern NSString *kUI_TURN_TO_DEVICEVC;
...
typedef NS_ENUM(UInt8, JLDeviceChangeType) {
    ...
    JLDeviceChangeTypeInitOK            = 5,    //初始化完成
};
...
/// 表盘参数拓展配置
@property(strong,nonatomic)JLDialInfoExtentedModel * _Nullable dialInfoExtentedModel;

/// 公共SDK信息
@property(strong,nonatomic)JLPublicSDKInfoModel * _Nullable publicSDKInfoModel;

/// 表盘管理
@property(strong,nonatomic)JLDialUnitMgr * _Nullable dialUnitMgr;
