...
@interface HorizontallyFlowLayout ()
...
@implementation HorizontallyFlowLayout

- (instancetype)initWithItemCountPerRow:(NSInteger)itemCountPerRow maxRowCount:(NSInteger)maxRowCount itemCountTotal:(NSInteger) itemCountTotal{
    self = [super init];
    if (self) {
        self.attributesArray = [NSMutableArray array];
        self.itemCountPerRow = itemCountPerRow;
        self.maxRowCount     = maxRowCount;
        self.itemCountTotal  = itemCountTotal;
