...
- (instancetype)init
{
    ...
    if (self) {
        ...
        CGFloat length = [self getWidthWithString:kJL_TXT("device_status_unconnected") font:FontMedium(13)];
...
-(void)setUuid:(NSString *)uuid{
    ...
    if (type == JLUuidTypeNeedOTA) {
        CGFloat length = [self getWidthWithString:kJL_TXT("need_upgrade_second") font:FontMedium(13)]+6.0;
        self.mLabelStatus.frame = CGRectMake(bgview.frame.size.width-length-12-30,20,length,15);
        self.mLabelStatus.textColor = [UIColor redColor];
        self.mLabelStatus.text = kJL_TXT("need_upgrade_second");
    ...
    if (type == JLUuidTypeConnected) {
        CGFloat length = [self getWidthWithString:kJL_TXT("device_status_connected") font:FontMedium(13)];
        self.mLabelStatus.frame = CGRectMake(bgview.frame.size.width-length-12-30,20,length,15);
    ...
    if (type == JLUuidTypePreparing) {
        CGFloat length = [self getWidthWithString:kJL_TXT("configing") font:FontMedium(13)]+6.0;
    ...
    if (type == JLUuidTypeInUse) {
        CGFloat length = [self getWidthWithString:kJL_TXT("device_status_using") font:FontMedium(13)]+6.0;
        self.mLabelStatus.frame = CGRectMake(bgview.frame.size.width-length-12-30,20,length,15);
        self.mLabelStatus.textColor = [UIColor colorWithRed:31.0/255.0 green:150.0/255.0 blue:243.0/255.0 alpha:1.0];
...
- (void)setIsWorking:(BOOL)isWorking{
    ...
    if (self.isConnect && self.isWorking) {
        CGFloat length = [self getWidthWithString:kJL_TXT("device_status_using") font:FontMedium(13)];
        self.mLabelStatus.frame = CGRectMake(bgview.frame.size.width-length-12-30,20,length,15);
        bgview.layer.borderColor = kColor_0000.CGColor;
