...
-(void)updateUI{
    ...
    deviceLab.font = FontMedium(18.0);
    deviceLab.text = kJL_TXT("my_devices");
    ...
    [connectBtn setTitle:kJL_TXT("connect_device") forState:UIControlStateNormal];
    ...
    connectBtn.titleLabel.font = FontMedium(13.0);
