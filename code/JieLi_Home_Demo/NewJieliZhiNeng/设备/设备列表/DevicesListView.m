...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _noDeviceLab.text = kJL_TXT("unconnected_device_tips");
        ...
        _noDeviceLab.font = FontMedium(14.0);
...
-(__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (type == JLUuidTypeDisconnected) {
        ...
        cell.connectStatusLab.text = kJL_TXT("device_status_unconnected");
    }
    /*--- 已连接 ---*/
    if (type == JLUuidTypeConnected) {
        ...
        cell.connectStatusLab.text = kJL_TXT("device_status_connected");
    }
    ...
    if (type == JLUuidTypePreparing) {
        ...
        cell.connectStatusLab.text = kJL_TXT("configing2");
    }
    
    /*--- 正在使用 ---*/
    if (type == JLUuidTypeInUse) {
        cell.connectStatusLab.textColor = [UIColor colorWithRed:31.0/255.0 green:150.0/255.0 blue:243.0/255.0 alpha:1.0];
        cell.connectStatusLab.text = kJL_TXT("device_status_using_1");
    }
    /*--- 需要OTA升级 ---*/
    if (type == JLUuidTypeNeedOTA) {
        ...
        cell.connectStatusLab.text = kJL_TXT("need_upgrade");
    }
...
-(void)deviceCellDidSelectWith:(int)indexPath{
    kJLLog(JLLOG_DEBUG,@"Delete indexPath:%d",indexPath);
    DeviceObjc *model = _dataArray[indexPath];
