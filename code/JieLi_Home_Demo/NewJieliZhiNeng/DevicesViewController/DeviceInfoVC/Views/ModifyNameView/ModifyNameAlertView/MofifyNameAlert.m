...
-(void)updateAlertInfo{
    ...
    if([kJL_GET hasPrefix:@"zh"]){
        ...
        if (@available(iOS 13.0, *)) {
            ...
            NSMutableAttributedString *robotTip2_Str = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("device_name_change_tips") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: myColor}];

            robotTip2.attributedText = robotTip2_Str;
        } else {
            // Fallback on earlier versions
            NSMutableAttributedString *robotTip2_Str = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("device_name_change_tips") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:36/255.0 green:36/255.0 blue:36/255.0 alpha:1.0]}];
        ...
        if (@available(iOS 13.0, *)) {
            ...
            NSMutableAttributedString *robotTip3_Str = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("modify_dev_name_tips") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 12],NSForegroundColorAttributeName: myColor}];

            robotTip3.attributedText = robotTip3_Str;
        } else {
            // Fallback on earlier versions
            NSMutableAttributedString *robotTip3_Str = [[NSMutableAttributedString alloc] initWithString:kJL_TXT("modify_dev_name_tips") attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 12],NSForegroundColorAttributeName: [UIColor colorWithRed:126/255.0 green:126/255.0 blue:126/255.0 alpha:1.0]}];
