...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        gl.frame = CGRectMake(0,0,[UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
        ...
        contentView = [[UIImageView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height-250, [UIScreen mainScreen].bounds.size.width,187)];
        contentView.image = [UIImage imageNamed:@"Theme.bundle/login_bg_01"];
        contentView.contentMode = UIViewContentModeScaleToFill;
        [self addSubview:contentView];
        
        bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-150)];
