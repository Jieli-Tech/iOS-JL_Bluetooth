...
-(void)updateTopImage:(JL_DeviceType)mType{
    ...
    }else if(mType == JL_DeviceTypeChargingBin){
        [DFUITools setButton:self.btnDevice Image:@"Theme.bundle/chargingBin_mul_icon"];
    }else if(mType == JL_DeviceTypeDongle){
        [DFUITools setButton:self.btnDevice Image:@"icon_mul_dongle_white"];
    }else{
        [DFUITools setButton:self.btnDevice Image:@"Theme.bundle/Mul_icon_ear_nor"];
    }
}
