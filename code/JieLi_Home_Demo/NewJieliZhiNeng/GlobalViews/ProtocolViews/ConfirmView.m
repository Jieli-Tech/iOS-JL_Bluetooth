...
- (instancetype)init
{
    ...
    if (self) {
        ...
        tipsTitle.text = kJL_TXT("dialog_tips");
        ...
        [confirmBtn setTitle:kJL_TXT("agree_and_use") forState:UIControlStateNormal];
        confirmBtn.layer.cornerRadius = 20.0;
        confirmBtn.layer.masksToBounds = YES;
        [cancelBtn setTitle:kJL_TXT("not_agree_and_exit") forState:UIControlStateNormal];
